...
Υλοποιεί όλη τη κωδικοποιήση του δεύτερου επιπέδου με το ακόλουθο signature:
\begin{center}
...
\noindent Επιστρέφει τις ακόλουθες μεταβλητές:
\begin{description}
\item[\Q{AACSeq2:}] Δομή δίαστάσεων $K \times 1$, όπου $K$ το πλήθος των
...
Υλοποιεί όλη την απόκωδικοποιήση του δεύτερου επιπέδου με το ακόλουθο
signature:
\begin{center}
